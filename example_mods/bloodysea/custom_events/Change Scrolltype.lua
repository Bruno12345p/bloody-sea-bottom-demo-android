...
function onEvent(name, value1, value2)
	if name == 'Change Scrolltype' then
		...
		elseif value1 == 'anti' then
			Vertical = not defaultVert
			runTimer('Vertical', 0.0001)
		
		elseif value1 == 'very unfunny' then
			veryBoi = true
		...
		if value2 == 'off' or value2 == 'on' then
		...
		elseif value2 == 'anti' then
			Horizontal = not defaultHori
			runTimer('Horizontal', 0.0001)
		
		elseif value2 == 'unfunny' then
